...
public class ThirdPartyController {
    ...
    public Account makeThirdPartyTransference (@RequestBody ThirdPartyTransactionDTO thirdPartyTransactionDTO){
        return thirdPartyService.makeThirdPartyTransference(thirdPartyTransactionDTO);
    }
